...
export function ProviderCard({
  ...
  return (
    <Card
      ...
      className={data.isHub ? 'provider-card provider-card-hub' : 'provider-card'}
      elevation={0}
      onDragOver={(event) => {
    ...
    >
      <CardContent>
        <Stack direction="row" className="provider-node-header">
          ...
          <Box className="provider-node-status" />
        </Stack>
                  ...
                  {items.map((entity) => {
                    ...
                    return (
                      <Chip
                        ...
                        onDelete={
                          data.isHub ? undefined : (event) => stopDeleteClick(event, payload)
                        }
