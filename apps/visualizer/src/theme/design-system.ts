    ...
    components: {
      MuiCssBaseline: {
        styleOverrides: {
          ...
          '.provider-connectors line': {
            stroke:
              'color-mix(in srgb, var(--mui-palette-primary-main) 32%, var(--mui-palette-divider))',
            strokeWidth: 1,
          ...
          '.provider-node-status-unavailable': {
